...
LyteBox.prototype.initialize = function() {
	...
	var objClose = this.doc.createElement("a");
		...
		//objOverlay.appendChild(objClose);
...
LyteBox.prototype.resizeContainer = function(imgWidth, imgHeight) {
	...
	this.doc.getElementById('lbOuterContainer').style.marginLeft = "-" + MarginLeft + "px";
        this.doc.getElementById('lbOuterContainer').style.marginTop = "-" + MarginTop + "px";
        this.doc.getElementById('lbOuterContainer').style.display = 'block';
        this.showContent();
};
...
LyteBox.prototype.updateDetails = function() {
	...
	if (this.isSlideshow && this.slideArray.length > 1) {
		...
		object.style.display = '';
		//object.innerHTML = "Image " + eval(this.activeImage + 1) + " of " + this.imageArray.length;   //Ahmet Saribas 01.03.2012
