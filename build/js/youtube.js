            ...
            if (YouTubeDialog == null) {
                ...
                YouTubeDialog.dialog({ autoOpen: false, resizable: false, draggable: options.draggable, modal: options.modal,
                    close: function () {
                        ...
                        //YouTubeDialog.dialog.append("<div class='close_video'></div>");
                       // $(".close_video").show();
                    }
                });
            }
            ...
            return this.each(function () {
                ...
                if (!data) { //check if event is already assigned
                    ...
                    $(obj).bind('click.YouTubePopup', function () {
                        ...
                        //Format YouTube URL
                        var YouTubeURL = "http://www.youtube.com/embed/" + youtubeId + "?rel=0&wmode=transparent&showsearch=0&autohide=" + options.autohide;
                        ...
                        YouTubeDialog.append("<div class='close'></div>");
                        ...
                        if(options.clickOutsideClose && options.modal){ //assign clickOutsideClose event only if Modal option is enabled
                            ...
                            $(".close").click(function () { YouTubeDialog.dialog("close"); $(".loading").remove();}); //assign Click event to overlay
                        }
                        return false;
                    });
                }
